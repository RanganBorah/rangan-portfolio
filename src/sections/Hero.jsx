      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 lg:grid-cols-2 lg:items-center">
        ...
        >
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-400">
            ...
            continuously learning and improving technical skills to gain
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <a
              href="https://moodora-ai.vercel.app/"
              target="_blank"
              rel="noreferrer"
              className="rounded-xl border border-emerald-500 px-5 py-3 text-sm font-semibold text-emerald-300 transition duration-300 hover:-translate-y-1 hover:bg-emerald-500/10"
            >
              Moodora Demo
            </a>
          </div>
        ...
        >
          ...
          <h3 className="mt-3 text-2xl font-semibold text-white">
            AI, Computer Vision, Web Development &amp; Embedded Systems
          </h3>

          <div className="mt-6 space-y-4">
            <div className="rounded-xl border border-slate-800 bg-slate-950/80 p-4 transition duration-300 hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/5">
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-950/80 p-4 transition duration-300 hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/5">
              ...
              <p className="mt-1 text-slate-200">
                Mood-based music recommendation using MediaPipe and Spotify
              </p>
            </div>
